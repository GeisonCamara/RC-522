...
app.use('/jquery', express.static(__dirname, '/content/libs/jquery/dist/'));
console.log(express.static(__dirname, '/content/libs/jquery/dist/'));
app.use('/notifyjs', express.static(__dirname, '/node_modules/notifyjs/dist/'));
